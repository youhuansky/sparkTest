...
object Appltcation extends App {
  ...
  //3.加载需要处理的数据文本
  val textFile = sparkContext.textFile("C:\\Users\\Administrator\\Desktop\\0223_2.txt")
  ...
  //4.输出数据文件的结果
  value1.saveAsTextFile("C:\\Users\\Administrator\\Desktop\\0223_2_res")
  ...
  def getPartnerordeid(str: String): String = {
    println(str)
    var partnerordeid = str.split("\\|")(11)
